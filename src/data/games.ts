...
export const games: Game[] = [
  ...
  { id: "forever_winter", name: "The Forever Winter", steamAppId: 2084000, releaseYear: 2024, genre: ["FPS", "Survival"], supportedOS: ["windows"], minRequirements: { gpu: "GTX 1060", cpu: "Intel Core i5-6600K", ram: 12, vram: 6 }, recommendedRequirements: { gpu: "RTX 3070", cpu: "Intel Core i7-9700K", ram: 16, vram: 8 } },
  { id: "space_marine2", name: "Warhammer 40,000: Space Marine 2", steamAppId: 2183900, releaseYear: 2024, genre: ["Action", "Shooter"], supportedOS: ["windows"], minRequirements: { gpu: "GTX 1060", cpu: "Intel Core i5-8600K", ram: 8, vram: 6 }, recommendedRequirements: { gpu: "RTX 3070", cpu: "Intel Core i7-12700K", ram: 16, vram: 8 } },
  ...
  { id: "fatepg", name: "Fate/Samurai Remnant", steamAppId: 2134660, releaseYear: 2023, genre: ["Action", "RPG"], supportedOS: ["windows"], minRequirements: { gpu: "GTX 1060", cpu: "Intel Core i5-7500", ram: 12, vram: 6 }, recommendedRequirements: { gpu: "RTX 3060", cpu: "Intel Core i7-8700K", ram: 16, vram: 8 } },
  { id: "robocop", name: "RoboCop: Rogue City", steamAppId: 1681430, releaseYear: 2023, genre: ["FPS", "Action"], supportedOS: ["windows"], minRequirements: { gpu: "GTX 1060", cpu: "Intel Core i5-8400", ram: 12, vram: 6 }, recommendedRequirements: { gpu: "RTX 3070", cpu: "Intel Core i7-9700K", ram: 16, vram: 8 } },
  { id: "parakids", name: "Payday 3", steamAppId: 1272080, releaseYear: 2023, genre: ["FPS", "Co-op"], supportedOS: ["windows"], minRequirements: { gpu: "GTX 1060", cpu: "Intel Core i5-8400", ram: 16, vram: 6 }, recommendedRequirements: { gpu: "RTX 3060", cpu: "Intel Core i7-9700K", ram: 16, vram: 8 } },
  { id: "wolong", name: "Wo Long: Fallen Dynasty", steamAppId: 1448440, releaseYear: 2023, genre: ["Action", "RPG"], supportedOS: ["windows"], minRequirements: { gpu: "GTX 1060", cpu: "Intel Core i5-8400", ram: 8, vram: 6 }, recommendedRequirements: { gpu: "RTX 3060", cpu: "Intel Core i7-9700K", ram: 16, vram: 8 } },
  { id: "marvelmidnight", name: "Marvel's Midnight Suns", steamAppId: 368260, releaseYear: 2022, genre: ["Strategy", "RPG"], supportedOS: ["windows"], minRequirements: { gpu: "GTX 1060", cpu: "Intel Core i5-8400", ram: 16, vram: 6 }, recommendedRequirements: { gpu: "RTX 3070", cpu: "Intel Core i7-9700K", ram: 16, vram: 8 } },
  { id: "deadlink", name: "Deadlink", steamAppId: 1676130, releaseYear: 2024, genre: ["FPS", "Roguelike"], supportedOS: ["windows"], minRequirements: { gpu: "GTX 1050 Ti", cpu: "Intel Core i5-4460", ram: 8, vram: 4 }, recommendedRequirements: { gpu: "RTX 2060", cpu: "Intel Core i7-8700K", ram: 16, vram: 6 } },
  { id: "banishers", name: "Banishers: Ghosts of New Eden", steamAppId: 1706460, releaseYear: 2024, genre: ["Action", "RPG"], supportedOS: ["windows"], minRequirements: { gpu: "GTX 1060", cpu: "Intel Core i5-8400", ram: 16, vram: 6 }, recommendedRequirements: { gpu: "RTX 3070", cpu: "Intel Core i7-10700K", ram: 16, vram: 8 } },
  { id: "soulscalibur6", name: "Soulcalibur VI", steamAppId: 544750, releaseYear: 2018, genre: ["Fighting", "Action"], supportedOS: ["windows"], minRequirements: { gpu: "GTX 1050", cpu: "Intel Core i5-4590", ram: 6, vram: 2 }, recommendedRequirements: { gpu: "GTX 1060", cpu: "Intel Core i7-4770K", ram: 8, vram: 4 } },
  { id: "granblue", name: "Granblue Fantasy: Relink", steamAppId: 881020, releaseYear: 2024, genre: ["Action", "RPG"], supportedOS: ["windows"], minRequirements: { gpu: "GTX 1060", cpu: "Intel Core i5-8400", ram: 16, vram: 6 }, recommendedRequirements: { gpu: "RTX 3060", cpu: "Intel Core i7-9700K", ram: 16, vram: 8 } },
  { id: "universesandbox", name: "Universe Sandbox", steamAppId: 230290, releaseYear: 2015, genre: ["Simulation", "Space"], supportedOS: ["windows", "macos", "linux"], minRequirements: { gpu: "GTX 750 Ti", cpu: "Intel Core i5-4460", ram: 4, vram: 2 }, recommendedRequirements: { gpu: "GTX 1060", cpu: "Intel Core i7-6700K", ram: 8, vram: 4 } },
  { id: "peopleplayground", name: "People Playground", steamAppId: 1118200, releaseYear: 2019, genre: ["Simulation", "Sandbox"], supportedOS: ["windows", "macos", "linux"], minRequirements: { gpu: "Intel HD 4000", cpu: "Intel Core 2 Duo", ram: 4, vram: 1 }, recommendedRequirements: { gpu: "GTX 660", cpu: "Intel Core i5-4690", ram: 8, vram: 2 } },
  { id: "teardowngame", name: "Teardown", steamAppId: 1167630, releaseYear: 2022, genre: ["Simulation", "Destruction"], supportedOS: ["windows"], minRequirements: { gpu: "GTX 970", cpu: "Intel Core i7-6700K", ram: 8, vram: 4 }, recommendedRequirements: { gpu: "RTX 3060", cpu: "Intel Core i7-10700K", ram: 16, vram: 8 } },
  { id: "goatsimu3", name: "Goat Simulator 3", steamAppId: 1466990, releaseYear: 2022, genre: ["Simulation", "Comedy"], supportedOS: ["windows"], minRequirements: { gpu: "GTX 1050 Ti", cpu: "Intel Core i5-4690", ram: 8, vram: 4 }, recommendedRequirements: { gpu: "RTX 2070", cpu: "Intel Core i7-9700K", ram: 16, vram: 8 } },
  { id: "pacificdrives", name: "Pacific Drive", steamAppId: 1458140, releaseYear: 2024, genre: ["Survival", "Adventure"], supportedOS: ["windows"], minRequirements: { gpu: "GTX 1060", cpu: "Intel Core i5-8600K", ram: 16, vram: 6 }, recommendedRequirements: { gpu: "RTX 3070", cpu: "Intel Core i7-10700K", ram: 16, vram: 8 } },
  ...
  { id: "snufkinmoon", name: "Snufkin: Melody of Moominvalley", steamAppId: 1864820, releaseYear: 2024, genre: ["Adventure", "Puzzle"], supportedOS: ["windows", "macos"], minRequirements: { gpu: "Intel HD 4000", cpu: "Intel Core 2 Duo", ram: 4, vram: 1 }, recommendedRequirements: { gpu: "GTX 660", cpu: "Intel Core i5-4690", ram: 8, vram: 2 } },
  ...
  { id: "oncehuman", name: "Once Human", steamAppId: 2139460, releaseYear: 2024, genre: ["Survival", "MMO"], supportedOS: ["windows"], minRequirements: { gpu: "GTX 1050 Ti", cpu: "Intel Core i5-6600K", ram: 8, vram: 4 }, recommendedRequirements: { gpu: "RTX 3060", cpu: "Intel Core i7-9700K", ram: 16, vram: 8 } },
  { id: "theswarm", name: "The First Descendant", steamAppId: 2074920, releaseYear: 2024, genre: ["Shooter", "RPG"], supportedOS: ["windows"], minRequirements: { gpu: "GTX 1050 Ti", cpu: "Intel Core i5-3570K", ram: 8, vram: 4 }, recommendedRequirements: { gpu: "RTX 3060", cpu: "Intel Core i7-9700K", ram: 16, vram: 8 } },
  { id: "dustborn", name: "Dustborn", steamAppId: 1497060, releaseYear: 2024, genre: ["Adventure", "Action"], supportedOS: ["windows"], minRequirements: { gpu: "GTX 1060", cpu: "Intel Core i5-6600K", ram: 8, vram: 6 }, recommendedRequirements: { gpu: "RTX 3060", cpu: "Intel Core i7-9700K", ram: 16, vram: 8 } },
  { id: "thanebreaker", name: "Flintlock: The Siege of Dawn", steamAppId: 1832040, releaseYear: 2024, genre: ["Action", "RPG"], supportedOS: ["windows"], minRequirements: { gpu: "GTX 1060", cpu: "Intel Core i5-8400", ram: 16, vram: 6 }, recommendedRequirements: { gpu: "RTX 3070", cpu: "Intel Core i7-10700K", ram: 16, vram: 8 } },
  { id: "kunitsu", name: "Kunitsu-Gami: Path of the Goddess", steamAppId: 2510710, releaseYear: 2024, genre: ["Action", "Strategy"], supportedOS: ["windows"], minRequirements: { gpu: "GTX 1060", cpu: "Intel Core i5-8400", ram: 16, vram: 6 }, recommendedRequirements: { gpu: "RTX 3070", cpu: "Intel Core i7-10700K", ram: 16, vram: 8 } }
];
