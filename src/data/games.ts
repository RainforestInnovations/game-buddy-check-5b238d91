...
export const games: Game[] = [
  ...
  { id: "hollowknightsilksong", name: "Hollow Knight: Silksong", steamAppId: 1030300, releaseYear: 2025, genre: ["Action", "Metroidvania"], supportedOS: ["windows", "macos", "linux"], hasBenchmark: false, minRequirements: { gpu: "GTX 560", cpu: "Intel Core i5-2300", ram: 4, vram: 1 }, recommendedRequirements: { gpu: "GTX 1050 Ti", cpu: "Intel Core i5-6600", ram: 8, vram: 4 } },
